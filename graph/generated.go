...
func (ec *executionContext) field_Mutation_createTodo_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewTodo2gqlgenᚑtodosᚋgraphᚋmodelᚐNewTodo(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_createUser_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewUser2gqlgenᚑtodosᚋgraphᚋmodelᚐNewUser(ctx, tmp)
	}
...
func (ec *executionContext) unmarshalNNewTodo2gqlgenᚑtodosᚋgraphᚋmodelᚐNewTodo(ctx context.Context, v any) (model.NewTodo, error) {
	res, err := ec.unmarshalInputNewTodo(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNNewUser2gqlgenᚑtodosᚋgraphᚋmodelᚐNewUser(ctx context.Context, v any) (model.NewUser, error) {
